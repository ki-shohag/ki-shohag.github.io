...
$("#comShopPrevBtn").click(function() {
    ...
    $("#modalPic-1").attr("src", "../assets/img/projects/computer-shop/1.JPG");
    $("#modalPic-2").attr("src", "../assets/img/projects/computer-shop/2.JPG");
    $("#modalPic-3").attr("src", "../assets/img/projects/computer-shop/3.JPG");
    $("#modalPic-4").attr("src", "../assets/img/projects/computer-shop/4.JPG");
    $("#modalPic-5").attr("src", "../assets/img/projects/computer-shop/5.JPG");
    $("#modalPic-6").attr("src", "../assets/img/projects/computer-shop/6.JPG");
    $("#modalPic-7").attr("src", "../assets/img/projects/computer-shop/7.JPG");
    $("#modalPic-8").attr("src", "../assets/img/projects/computer-shop/8.JPG");
    $("#modalPic-9").attr("src", "../assets/img/projects/computer-shop/9.JPG");
    $("#modalPic-10").attr("src", "../assets/img/projects/computer-shop/10.JPG");
    $("#modalPic-11").attr("src", "../assets/img/projects/computer-shop/11.JPG");
    $("#modalPic-12").attr("src", "../assets/img/projects/computer-shop/12.JPG");
    $("#modalPic-13").attr("src", "../assets/img/projects/computer-shop/13.JPG");
    $("#modalPic-14").attr("src", "../assets/img/projects/computer-shop/14.JPG");
    for (var i = 15; i < 26; i++) {
        $("#modalPic-" + i).attr("src", "");
    }
    $("#introParagraph").text(
    ...
    $("#techItems").html("");
    $("#techItems").html(
        "<li>Node.Js</li><li>Express Js</li><li>JavaScript</li><li>HTML</li><li>CSS</li><li>Bootstrap</li><li>jQuery</li><li>Ajax</li><li>MySQL</li>"
    );
});
